...
static const char* j_4f7g6fui(int32_t j_zjsufqwi)
{
    ...
    static volatile int64_t j_ql8pat8l = 86933;
    if ((((j_ql8pat8l * (j_ql8pat8l + 1)) % 2) == 1))
    {
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    if ((j_zjsufqwi == 0))
    ...
    return "odd";
    static volatile int64_t j_vogp4vxx = 81491;
    if ((((j_vogp4vxx * j_vogp4vxx) + j_vogp4vxx) < 0))
    {
        volatile int64_t j_ehlw0m3t = ((j_vogp4vxx * 27) + 491);
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    return 0;
}
...
static int32_t j_t2hghb9f(int32_t j_zjsufqwi)
{
    ...
    static volatile int64_t j_uz7o1dww = 68996;
    static volatile int64_t j_cl9v0u1j = 12415;
    if ((((j_cl9v0u1j * j_cl9v0u1j) + j_cl9v0u1j) < 0))
    {
        volatile int64_t j_d8trjgcf = ((j_cl9v0u1j * 60) + 415);
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    static volatile int64_t j_gd3i4eu3 = 96421;
    if ((((j_gd3i4eu3 * j_gd3i4eu3) + j_gd3i4eu3) < 0))
    {
        volatile int64_t j_wz7tww6m = ((j_gd3i4eu3 * 51) + 421);
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    ...
    static volatile int64_t j_esi0ml05 = 4121;
    if ((((j_esi0ml05 * (j_esi0ml05 + 1)) % 2) == 1))
    {
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    return ((j_zjsufqwi * 3) + 1);
    static volatile int64_t j_2rhh3gut = 2944;
    static volatile int64_t j_si31ndk9 = 28527;
    if ((((j_si31ndk9 * j_si31ndk9) + j_si31ndk9) < 0))
    {
        volatile int64_t j_e63tox7h = ((j_si31ndk9 * 79) + 527);
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    if ((((j_2rhh3gut * j_2rhh3gut) % 4) < 2))
    {
    }
    else
    {
    ...
    static volatile int64_t j_gmqpdmt0 = 1103;
    if ((((j_gmqpdmt0 * j_gmqpdmt0) + j_gmqpdmt0) < 0))
    {
        volatile int64_t j_c8jewur5 = ((j_gmqpdmt0 * 3) + 103);
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    return 0;
}
...
static int32_t j_oiwo6t0n(int32_t j_zjsufqwi)
{
    ...
    static volatile int64_t j_qo32bb5q = 60293;
    static volatile int64_t j_ifxsxp8l = 12744;
    if ((((j_ifxsxp8l * j_ifxsxp8l) + j_ifxsxp8l) < 0))
    {
        volatile int64_t j_l9dl9lcd = ((j_ifxsxp8l * 92) + 744);
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    ...
    static volatile int64_t j_7m5fgot7 = 69910;
    static volatile int64_t j_yn30xwb1 = 51868;
    if ((((j_yn30xwb1 * j_yn30xwb1) + j_yn30xwb1) < 0))
    {
        volatile int64_t j_kiietxma = ((j_yn30xwb1 * 66) + 868);
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    if ((((j_7m5fgot7 * j_7m5fgot7) + j_7m5fgot7) < 0))
    {
        volatile int64_t j_v3huvf2v = ((j_7m5fgot7 * 28) + 910);
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    int32_t j_qb8n9rkr = j_zjsufqwi;
    static volatile int64_t j_fy0gpnl9 = 66990;
    if ((((j_fy0gpnl9 * j_fy0gpnl9) + j_fy0gpnl9) < 0))
    {
        volatile int64_t j_c1wchsa4 = ((j_fy0gpnl9 * 92) + 990);
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    while ((j_qb8n9rkr != 1))
    {
        j_qb8n9rkr = j_t2hghb9f(j_qb8n9rkr);
...
{
    (void)printf("%s\n", "=== COLLATZ STEPS ===");
    static volatile int64_t j_lyd9q6x2 = 43089;
    if ((((j_lyd9q6x2 * (j_lyd9q6x2 + 1)) % 2) == 1))
    {
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    int32_t j_xsop1o4p = 1;
    while ((j_xsop1o4p <= 8))
    {
        (void)printf("%d\n", j_oiwo6t0n(j_xsop1o4p));
        j_xsop1o4p = (j_xsop1o4p + 1);
    }
    static volatile int64_t j_ney0af9f = 13878;
    if ((((j_ney0af9f * j_ney0af9f) + j_ney0af9f) < 0))
    {
        volatile int64_t j_dj8cfjgn = ((j_ney0af9f * 50) + 878);
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    static volatile int64_t j_mbs50pn8 = 95933;
    ...
    static volatile int64_t j_gzdn22af = 68258;
    if ((((j_gzdn22af * j_gzdn22af) + j_gzdn22af) < 0))
    {
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    (void)printf("%s\n", "=== CLASSIFICATION ===");
    for (int32_t j_2ct6q877 = -(3); (j_2ct6q877 <= 6); j_2ct6q877 = (j_2ct6q877 + 1))
    {
        (void)printf("%s\n", j_4f7g6fui(j_2ct6q877));
    }
    (void)printf("%s\n", "=== AGGREGATE ===");
    ...
    while ((j_zjsufqwi <= 10))
    {
        j_f1hbv9t4 = (j_f1hbv9t4 + j_oiwo6t0n(j_zjsufqwi));
