...
static bool j_4f7g6fui(int32_t j_zjsufqwi)
{
    ...
    int32_t j_w0m3tuz7 = 2;
    while (((j_w0m3tuz7 * j_w0m3tuz7) <= j_zjsufqwi))
    {
        if (((j_zjsufqwi % j_w0m3tuz7) == 0))
        {
            return false;
        }
        j_w0m3tuz7 = (j_w0m3tuz7 + 1);
    }
    return true;
    return 0;
}
...
static int32_t j_t2hghb9f(int32_t j_oiwo6t0n)
{
    static volatile int64_t j_1dwwcl9v = 98618;
    if ((j_1dwwcl9v * j_1dwwcl9v) >= 0)
    {
    }
    else
    {
    ...
    static volatile int64_t j_u1jd8trj = 29650;
    if ((j_u1jd8trj * j_u1jd8trj) >= 0)
    {
    }
    else
    {
    ...
    static volatile int64_t j_cfgd3i4e = 84688;
    if ((j_cfgd3i4e * j_cfgd3i4e) >= 0)
    {
    }
    else
    {
    ...
    int32_t j_3wz7tww6 = 0;
    for (int32_t j_mesi0ml0 = 0; (j_mesi0ml0 < j_oiwo6t0n); j_mesi0ml0 = (j_mesi0ml0 + 1))
    {
        j_3wz7tww6 = (j_3wz7tww6 + j_mesi0ml0);
    }
    return j_3wz7tww6;
    return 0;
}
...
int32_t main(void)
{
    static volatile int64_t j_2rhh3gut = 30586;
    if ((j_2rhh3gut * j_2rhh3gut) >= 0)
    {
    }
    else
    {
    ...
    static volatile int64_t j_i31ndk9e = 51596;
    if ((j_i31ndk9e * j_i31ndk9e) >= 0)
    {
    }
    else
    {
    ...
    const char* j_3tox7hgm = "JOCKY forensic language v0.1";
    int32_t j_qpdmt0c8 = j_t2hghb9f(10);
    (void)printf("%s\n", j_3tox7hgm);
    (void)printf("%d\n", j_qpdmt0c8);
    const char* j_jewur546 = "prime";
    if ((j_4f7g6fui(7) && (j_str_len(j_jewur546) == 5)))
    {
        (void)printf("%s\n", true ? "true" : "false");
    }
    else
