// JOCKY build 6E68DFCF73E0FDE1 seed=12345 date=2026-09-03 05:00:02
#include <stdio.h>
#include <stdint.h>
#include <stdbool.h>
#include <string.h>
...
static bool j_4f7g6fui(int32_t j_zjsufqwi)
{
    ...
    int32_t j_vogp4vxx = 2;
    while (((j_vogp4vxx * j_vogp4vxx) <= j_zjsufqwi))
    {
        if (((j_zjsufqwi % j_vogp4vxx) == 0))
        {
            return false;
        }
        j_vogp4vxx = (j_vogp4vxx + 1);
    }
    return true;
...
static int32_t j_t2hghb9f(int32_t j_oiwo6t0n)
{
    static volatile int64_t j_cl9v0u1j = 4121;
    static volatile int64_t j_d8trjgcf = 12415;
    if ((((j_d8trjgcf * j_d8trjgcf) + j_d8trjgcf) < 0))
    {
        volatile int64_t j_gd3i4eu3 = ((j_d8trjgcf * 60) + 415);
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    if ((((j_cl9v0u1j * (j_cl9v0u1j + 1)) % 2) == 1))
    {
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    int32_t j_wz7tww6m = 0;
    static volatile int64_t j_esi0ml05 = 2944;
    static volatile int64_t j_2rhh3gut = 28527;
    if ((((j_2rhh3gut * j_2rhh3gut) + j_2rhh3gut) < 0))
    {
        volatile int64_t j_si31ndk9 = ((j_2rhh3gut * 79) + 527);
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    if ((((j_esi0ml05 * j_esi0ml05) % 4) < 2))
    {
    }
    else
    {
    ...
    for (int32_t j_e63tox7h = 0; (j_e63tox7h < j_oiwo6t0n); j_e63tox7h = (j_e63tox7h + 1))
    {
        j_wz7tww6m = (j_wz7tww6m + j_e63tox7h);
    }
    static volatile int64_t j_gmqpdmt0 = 96421;
    if ((((j_gmqpdmt0 * j_gmqpdmt0) + j_gmqpdmt0) < 0))
    {
        volatile int64_t j_c8jewur5 = ((j_gmqpdmt0 * 51) + 421);
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    static volatile int64_t j_468tmzoa = 1103;
    if ((((j_468tmzoa * j_468tmzoa) + j_468tmzoa) < 0))
    {
        volatile int64_t j_qo32bb5q = ((j_468tmzoa * 3) + 103);
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    static volatile int64_t j_ifxsxp8l = 68996;
...
int32_t main(void)
{
    const char* j_l9dl9lcd = "JOCKY forensic language v0.1";
    int32_t j_7m5fgot7 = j_t2hghb9f(10);
    (void)printf("%s\n", j_l9dl9lcd);
    (void)printf("%d\n", j_7m5fgot7);
    const char* j_yn30xwb1 = "prime";
    static volatile int64_t j_kiietxma = 51868;
    if ((((j_kiietxma * j_kiietxma) + j_kiietxma) < 0))
    {
        volatile int64_t j_v3huvf2v = ((j_kiietxma * 66) + 868);
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    if ((j_4f7g6fui(7) && (j_str_len(j_yn30xwb1) == 5)))
    {
        (void)printf("%s\n", true ? "true" : "false");
    }
    else
    ...
    static volatile int64_t j_fy0gpnl9 = 12744;
    static volatile int64_t j_c1wchsa4 = 66990;
    if ((((j_c1wchsa4 * j_c1wchsa4) + j_c1wchsa4) < 0))
    {
        volatile int64_t j_lyd9q6x2 = ((j_c1wchsa4 * 92) + 990);
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    if ((((j_fy0gpnl9 * j_fy0gpnl9) + j_fy0gpnl9) < 0))
    {
        volatile int64_t j_xsop1o4p = ((j_fy0gpnl9 * 92) + 744);
        (void)printf("%s\n", 0 ? "true" : "false");
    }
    int32_t j_ney0af9f = 0;
    static volatile int64_t j_dj8cfjgn = 69910;
    if ((((j_dj8cfjgn * j_dj8cfjgn) + j_dj8cfjgn) < 0))
    {
        volatile int64_t j_mbs50pn8 = ((j_dj8cfjgn * 28) + 910);
        (void)printf("%s\n", 0 ? "true" : "false");
    }
